...
class MyCalendarThree:
    ...
    def __init__(self):
        self.interval_tree = IntervalTree(0, 10**9)

    def book(self, startTime: int, endTime: int) -> int:
        self.interval_tree.update(self.interval_tree.root, startTime, endTime - 1, 1)
        return self.interval_tree.max_num_overlap(self.interval_tree.root, 0, 10**9)
